...
const NotificationDropdown = ({ notifications, onMarkRead, onClose }) => {
  ...
  return (
    <div 
      className="absolute right-0 top-full mt-4 w-[320px] sm:w-[400px] glass-premium rounded-[2rem] border border-white/[0.08] shadow-2xl overflow-hidden animate-in fade-in slide-in-from-top-2 duration-300 z-[200]"
